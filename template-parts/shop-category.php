							...
							<div class="head">Категории</div>
								<ul class="main-categories">
									<li class="common-filter">
										<form action="#">
											<ul>
												<li class="filter-list"><input class="pixel-radio" type="radio" id="men" name="brand"><label for="men">Футболки<span> (N/A)</span></label></li>
												<li class="filter-list"><input class="pixel-radio" type="radio" id="women" name="brand"><label for="women">Худи<span> (N/A)</span></label></li>
												<li class="filter-list"><input class="pixel-radio" type="radio" id="accessories" name="brand"><label for="accessories">Свитшоты<span> (N/A)</span></label></li>
												<li class="filter-list"><input class="pixel-radio" type="radio" id="footwear" name="brand"><label for="footwear">Носочки<span> (N/A)</span></label></li>
											</ul>
										</form>
									</li>
								</ul>
								...
								<div class="head">Color</div>
									<form action="#">
										<ul>
											...
											<li class="filter-list"><input class="pixel-radio" type="radio" id="balckleather" name="color"><label for="balckleather">BlackLeather<span>(29)</span></label></li>
											<li class="filter-list"><input class="pixel-radio" type="radio" id="blackred" name="color"><label for="blackred">Blackwith red<span>(19)</span></label></li>
				...
				<div class="row mt-30">
					...
					<div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
						<div class="single-search-product-wrapper">
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-1.png" alt=""></a>
								<div class="desc">
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-2.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-3.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
					...
					<div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
						<div class="single-search-product-wrapper">
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-4.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-5.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-6.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
					...
					<div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
						<div class="single-search-product-wrapper">
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-7.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-8.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
							...
							<div class="single-search-product d-flex">
								<a href="#"><img src="<?php bloginfo('template_directory') ?>/img/product/product-sm-9.png" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Gray Coffee Cup</a>
									<div class="price">$170.00</div>
								</div>
