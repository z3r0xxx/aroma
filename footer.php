				...
				<div class="col-lg-2 col-md-6 col-sm-6">
					<div class="single-footer-widget instafeed">
						...
						<ul class="list instafeed d-flex flex-wrap">
							...
							<li><img src="<?php bloginfo('template_directory') ?>/img/gallery/r3.jpg" alt=""></li>
							<li><img src="<?php bloginfo('template_directory') ?>/img/gallery/r5.jpg" alt=""></li>
							<li><img src="<?php bloginfo('template_directory') ?>/img/gallery/r7.jpg" alt=""></li>
							<li><img src="<?php bloginfo('template_directory') ?>/img/gallery/r8.jpg" alt=""></li>
						</ul>
					</div>
				</div>
